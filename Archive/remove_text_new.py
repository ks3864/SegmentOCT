...
def inpaint_text(img_path, pipeline):
    ...
    for box in prediction_groups[0]:
        ...
        img[y0-40:y3+40, x0-20: x1+20] = [255, 255, 255]
...
#
img_text_removed = inpaint_text('RLS_127_OS_TC.jpg', pipeline)
#
plt.imshow(img_text_removed)
plt.show()
cv2.imwrite('text_removed_image12.jpg', cv2.cvtColor(img_text_removed, cv2.COLOR_BGR2RGB))